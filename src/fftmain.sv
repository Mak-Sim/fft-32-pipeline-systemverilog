...
//		line:
//
//		% ./fftgen -f 32 -1 -d ./fft-core-simple
//
//	This core will use hardware accelerated multiplies (DSPs)
//	for 0 of the 5 stages
//
...
module fftmain(i_clk, i_reset, i_ce,
	...
	localparam	IWIDTH=16, OWIDTH=19; // LGWIDTH=5;
	//
	input logic				i_clk, i_reset, i_ce;
	//
	input logic	[(2*IWIDTH-1):0]	i_sample;
	output logic	[(2*OWIDTH-1):0]	o_result;
	output logic				o_sync;


	// Outputs of the FFT, ready for bit reversal.
	logic				br_sync;
	logic	[(2*OWIDTH-1):0]	br_result;
